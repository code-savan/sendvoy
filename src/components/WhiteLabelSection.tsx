...
export function WhiteLabelSection() {
  ...
  return (
    <section className="py-24 bg-white overflow-hidden relative">
      ...
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-96 h-96 bg-orange-50 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            <FadeIn>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white transition-all duration-200 bg-orange-600 rounded-lg hover:bg-orange-700 hover:shadow-lg hover:shadow-orange-500/30">
                  Become a Partner
                </button>
          ...
          <FadeIn delay={0.2} direction="left">
            <div className="bg-gray-900 rounded-2xl p-8 sm:p-10 text-white shadow-2xl relative overflow-hidden">
              {/* Decorative circles */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-orange-600 rounded-full blur-3xl opacity-20 -mr-16 -mt-16"></div>
              <div className="absolute bottom-0 left-0 w-64 h-64 bg-orange-600 rounded-full blur-3xl opacity-20 -ml-16 -mb-16"></div>
              ...
              <div className="relative z-10">
                ...
                <ul className="space-y-5">
                  ...
                  <li key={index} className="flex items-start gap-3">
                      <CheckCircle2
                      className={`w-5 h-5 mt-0.5 flex-shrink-0 ${index === benefits.length - 1 ? 'text-yellow-400' : 'text-orange-400'}`} />
